...
function getProfileData (user) {
	...
	// Display the user's high-res photo
	...
	detailsContent += `<div class="row"><div class="col-6"><p><strong>Email</strong></p></div><div class="col-6"><p>${user.email}</p></div></div>`;
	...
	userData.onSnapshot((doc) => {
		...
		statsContent += `<div class="row"><div class="col-6"><strong>Active challenges</strong></p></div><div class="col-6"><p>${data.challenges - data.completed}</p></div></div>`;
		...
		settingsContent += `<div class="text-center"><button class="btn btn-sm btn-primary" onclick="saveChanges()">Save changes</button></div>`;
