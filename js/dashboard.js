...
function writeCard (counter) {
	...
	if (!challenge.complete) {
		...
		cardContent += '<button class="btn btn-sm btn-primary progress-edit" data-bs-toggle="modal" data-bs-target="#deleteChallengeModal" data-bs-challenge="' + counter + '" aria-label="Delete challenge"><i class="bi bi-x-circle-fill"></i></button>'; // Delete button
		cardContent += '<button class="btn btn-sm btn-primary progress-edit" aria-label="Edit challenge"><a href="./edit-challenge.html?challenge_id=' + counter + '"><i class="bi bi-pencil-square"></i></a></button>'; // Edit button
		cardContent += '<button class="btn btn-sm btn-primary progress-edit" data-bs-toggle="modal" data-bs-target="#addProgressModal" data-bs-challenge="' + counter + '" aria-label="Add progress"><i class="bi bi-plus-lg"></i></button>'; // Add progress button
		...
		cardContent += '<button class="btn btn-sm btn-primary progress-edit" data-bs-toggle="modal" data-bs-target="#deleteChallengeModal" data-bs-challenge="' + counter + '" aria-label="Delete challenge"><i class="bi bi-x-circle-fill"></i></button>'; // Delete button
		cardContent += '<button class="btn btn-sm btn-primary progress-edit" data-bs-toggle="modal" data-bs-target="#editChallengeModal" data-bs-challenge="' + counter + '" aria-label="Edit challenge"><i class="bi bi-pencil-square"></i></button>'; // Edit button
