...
primaryNavContents += '<li class="nav-item me-lg-2"><a class="nav-link" href="./index.html">Home</a></li>';
primaryNavContents += '<li class="nav-item me-lg-2"><a class="nav-link" href="./dashboard.html">Dashboard</a></li>';
primaryNavContents += '<li class="nav-item me-lg-2"><a class="nav-link" href="./profile.html">Profile</a></li>';
primaryNavContents += '<li class="nav-item me-lg-2"><a class="nav-link" href="./about.html">About</a></li>';
